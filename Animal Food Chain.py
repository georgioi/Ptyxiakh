...
bestValues = []                             #Best values of objective function for every iteration
iterations = []                             #How many iterations the algorithm run
...
print("Global Best:", globalBest,"\nGlobal Best value:",f(globalBest))#Plot diagram where X = iteratons and Y = f(bestValue)
...
#file = []
#file.append("\tRastrigin 30D Wild")
#for i in range(50):
...
#f = open("Animal Food Chain.txt","a")
#for line in file:
#    f.write(line+"\n")
#f.close()
